...
public class IOManager {
    ...
    @Deprecated public static final String SERIALIZED_CATEGORIES = "serializedDashboardCategories.ser";
    ...
    @Deprecated public static final String PREFS = "prefs.hashmap";
